...
The dictionary file [dicts/2of12.txt](dicts/2of12.txt) is from the [12 Dicts project](http://wordlist.aspell.net/12dicts-readme/), which is in the public domain.
